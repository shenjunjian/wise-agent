...
export function onText(role: AgentRoles, chunk: TextStreamPart<{}>, matchedFn: (message: AppMessage) => void) {
...
export function onTool(chunk: TextStreamPart<{}>, matchedFn: (message: ToolInputContent) => void) {
